...
client.on('ready', () => {
  ...
  // Oynuyor Kısmı
      ...
      var actvs = [
        `${prefix}yardım | Coded by yefeblgn`,
        `${prefix}yardım | Youtube - YEFE`, 
        `${prefix}yardım | Instagram - yefeblgn`
    ];
...
client.on('message', message =>{
const ey = message.content.toLowerCase()

if(ey === '14122020') {
message.channel.send(`<@820566315676598292> 💗 <@659515013433655309>`)
}
})

client.on('message', message =>{
const my = message.content.toLowerCase()

if(my === 'yiğiti etiketle') {
message.channel.send(`<@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968> <@599931617141587968>`)
}
})

client.on('message', message =>{
const se = message.content.toLowerCase()

if(se === 'slk efe') {
message.channel.send(`<@659515013433655309>`)
}
})

client.on('message', message =>{
const see = message.content.toLowerCase()

if(see === 'slk eda') {
message.channel.send(`<@820566315676598292>`)
}
})
...
if(my === 'yiğiti etiketle') {
message.channel.send(`**Etiketledimm:)**`)
}
})
...
message.channel.send(`İyi Geceleeerr <@${message.author.id}>`)
}
})
